        ...
        try {
            ...
            if (mode === "preserve") {
                try {
                    ...
                    const doesFileExist = !(isFileSystemError(error) && error.code === "ENOENT");
                    if (doesFileExist) {
                        return;
                    }
                    if (isGenericError(error)) {
                        return (0, core_1.setFailed)(error);
                    }
                    return (0, core_1.setFailed)("Failed to check if file exists in preserve mode");
                }
            }
            ...
            return (0, core_1.setFailed)("Failed to write to file");
        }
    });
}
